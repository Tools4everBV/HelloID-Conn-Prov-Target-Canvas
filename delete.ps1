...
try {
    ...
    if (-not($dryRun -eq $true)) {
        ...
        # Not sure of 204 is returned. Not specified in the docs
    ...
    if ($($ex.Exception.GetType().FullName -eq 'Microsoft.PowerShell.Commands.HttpResponseException') -or
        ...
        $errorMessage = "Could not delete Canvas account. Error: $($errorObj.ErrorMessage)"
    } else {
        $errorMessage = "Could not delete Canvas account. Error: $($ex.Exception.Message)"
    }
